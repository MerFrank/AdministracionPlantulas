...
// Obtener datos de la sucursal a editar
...
if (!$sucursal) {
    $_SESSION['error_message'] = 'Sucursal no encontrada';
...
<main class="container mt-4">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h2><i class="bi bi-shop"></i> Editar Sucursal</h2>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="direccion" rows="2" required><?= htmlspecialchars($sucursal['direccion']) ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" name="telefono" value="<?= htmlspecialchars($sucursal['telefono']) ?>">
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Responsable</label>
                            <input type="text" class="form-control" name="responsable" value="<?= htmlspecialchars($sucursal['responsable']) ?>">
                        </div>
                    </div>
                </div>
