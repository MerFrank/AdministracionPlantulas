...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['csrf_token'])) {
    ...
    try {
        ...
        $sql = "INSERT INTO Proveedores (
                  alias, nombre_proveedor, nombre_empresa, nombre_contacto, 
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $ruta_lista = 'lista_proveedores.php';
            ...
            if (file_exists($ruta_absoluta)) {
                ...
                throw new Exception("El archivo lista_proveedores.php no se encontró en: " . $ruta_absoluta);
            }
        } else {
        ...
        error_log("Error en registro_proveedor.php: " . $e->getMessage());
    } catch (Exception $e) {
        $error = $e->getMessage();
        error_log("Error en registro_proveedor.php: " . $e->getMessage());
    }
...
<head>
    ...
    <title>Registrar Proveedor - Plantulas</title>
    ...
    <style>
        ...
        .form-section h5 {
            ...
            border-bottom: 2px solid #45814d;
            color: #45814d;
        }
...
<?php
$encabezado = 'Proveedores'; // Título más corto para el header
$subtitulo = 'Regstro Proveedor'; // Opcional
        ...
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <div class="d-flex align-items-center">
                    <h2 class="mb-0"><i class="bi bi-truck"></i> Registrar Nuevo Proveedor</h2>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="post" id="proveedorForm" class="needs-validation" novalidate>
                        ...
                        <div class="col-md-6 form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="alias" name="alias" maxlength="255"
                                       placeholder="Nombre corto para identificar al proveedor"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre_proveedor" name="nombre_proveedor" required maxlength="255"
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="productos" name="productos" rows="3"
                                      placeholder="Describa los principales productos que provee"><?= htmlspecialchars($_POST['productos'] ?? '') ?></textarea>
                        </div>
                    </div>
